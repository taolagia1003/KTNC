...
public class KhachHangDAO extends storeAppDAO<KhachHang, String> {
	...
	public void insert(KhachHang model) {
		...
		XJDBC.update(sql, model.getMaKH(), model.getTenKH(), model.getDiaChi(), model.getSdt(), model.getEmail(),
				model.isThanhVien());
	}
	...
	public void update(KhachHang model) {
		...
		XJDBC.update(sql, model.getTenKH(), model.getDiaChi(), model.getSdt(), model.getEmail(), model.isThanhVien(),
				model.getMaKH());
	}
	...
	public void insertKHHD(KhachHang model) {
		...
		XJDBC.update(sql,
//        model.getMaKH(), 
				model.getTenKH(), model.getSdt());
	}

	public boolean checkInsertKH(String maKH, String tenKH, String diaChi, String sdt, String email,
			boolean thanhVien) {
		KhachHang kh = selectById(maKH);
		if (kh != null) {
			return false;
		} else if (maKH == null && tenKH == null && diaChi == null && sdt == null && email == null
				&& thanhVien == false) {
			return false;
		} else if (maKH == null || tenKH == null || diaChi == null || sdt == null
				|| email == null && thanhVien == false) {
			return false;
		}
		return true;
	}

	public boolean checkUpdateKH(String maKH, String tenKH, String diaChi, String sdt, String email,
			boolean thanhVien) {
		KhachHang kh = selectById(maKH);
		if (kh == null) {
			return false;
	...
	public boolean checkXoa(String MaKH) {
		KhachHang kh = selectById(MaKH);
		if (kh == null) {
			return false;
		} else if (MaKH == null) {
